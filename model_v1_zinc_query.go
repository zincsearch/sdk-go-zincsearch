...
type V1ZincQuery struct {
	...
	Highlight *V1QueryHighlight `json:"highlight,omitempty"`
...
// SetHighlight gets a reference to the given V1QueryHighlight and assigns it to the Highlight field.
